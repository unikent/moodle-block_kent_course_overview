...
$string['nocourses'] = 'Sorry, there is currently no course information to show.';
$string['ignore_roles'] = '2'; //Comma separated list of role ids to ignore from the course overview list
